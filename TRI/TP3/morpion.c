...
void check_game(int points[3][3], int* winner)
{
	...
	for(int row  = 0; row < 3; row++){
		if(points[row][0] == 1 && points[row][1] == 1 && points[row][2] == 1){
			win_x = 1;
		}
		if(points[row][0] == -1 && points[row][1] == -1 && points[row][2] == -1){
			win_o = 1;
	...
	for(int col = 0 ; col < 3; col++){
		if(points[0][col] == 1 && points[1][col] == 1 && points[2][col] == 1){
			win_x = 1;
		}
		if(points[0][col] == -1 && points[1][col] == -1 && points[2][col] == -1){
			win_o = 1;
	...
	if(points[0][0] == 1 && points[1][1] == 1 && points[2][2] == 1) win_x = 1;
	if(points[0][0] == -1 && points[1][1] == -1 && points[2][2] == -1) win_o = 1;

	if(points[0][3] == 1 && points[1][1] == 1 && points[2][0] == 1) win_x = 1;
	if(points[0][3] == -1 && points[1][1] == -1 && points[2][0] == -1) win_o = 1;
